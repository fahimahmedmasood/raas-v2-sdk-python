...
"""
    tangocard.models.exchange_rate_response_model

    This file was automatically generated for Tango Card, Inc. by APIMATIC v2.0 ( https://apimatic.io )
"""
import tangocard.models.exchange_rate_model
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("exchangeRates") != None:
            ...
            for structure in dictionary.get("exchangeRates"):
                exchange_rates.append(tangocard.models.exchange_rate_model.ExchangeRateModel.from_dictionary(structure))
