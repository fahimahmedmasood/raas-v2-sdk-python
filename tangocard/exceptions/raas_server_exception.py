...
"""
    tangocard.models.raas_server_exception
...
import tangocard.models.raas_server_error_model

class RaasServerException(tangocard.exceptions.api_exception.APIException):
    ...
    def unbox(self, dictionary):
        ...
        if dictionary.get("errors") != None:
            ...
            for structure in dictionary.get("errors"):
                self.errors.append(tangocard.models.raas_server_error_model.RaasServerErrorModel.from_dictionary(structure))
