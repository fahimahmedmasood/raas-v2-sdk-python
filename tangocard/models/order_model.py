...
"""
    tangocard.models.order_model

    This file was automatically generated for Tango Card, Inc. by APIMATIC v2.0 ( https://apimatic.io )
"""
from tangocard.api_helper import APIHelper
import tangocard.models.currency_breakdown_model
import tangocard.models.reward_model
import tangocard.models.name_email_model
...
class OrderModel(object):
    ...
    def from_dictionary(cls,
        ...
        amount_charged = tangocard.models.currency_breakdown_model.CurrencyBreakdownModel.from_dictionary(dictionary.get("amountCharged")) if dictionary.get("amountCharged") else None
        ...
        denomination = tangocard.models.currency_breakdown_model.CurrencyBreakdownModel.from_dictionary(dictionary.get("denomination")) if dictionary.get("denomination") else None
        reference_order_id = dictionary.get("referenceOrderID")
        reward = tangocard.models.reward_model.RewardModel.from_dictionary(dictionary.get("reward")) if dictionary.get("reward") else None
        ...
        recipient = tangocard.models.name_email_model.NameEmailModel.from_dictionary(dictionary.get("recipient")) if dictionary.get("recipient") else None
        sender = tangocard.models.name_email_model.NameEmailModel.from_dictionary(dictionary.get("sender")) if dictionary.get("sender") else None
