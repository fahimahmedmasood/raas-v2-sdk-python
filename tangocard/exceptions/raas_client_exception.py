...
"""
    tangocard.models.raas_client_exception

    This file was automatically generated for Tango Card, Inc. by APIMATIC v2.0 ( https://apimatic.io )
"""
import dateutil.parser
from ..api_helper import APIHelper
import tangocard.exceptions.api_exception
import tangocard.models.raas_client_error_model

class RaasClientException(tangocard.exceptions.api_exception.APIException):
    ...
    def unbox(self, dictionary):
        ...
        if dictionary.get("errors") != None:
            ...
            for structure in dictionary.get("errors"):
                self.errors.append(tangocard.models.raas_client_error_model.RaasClientErrorModel.from_dictionary(structure))
